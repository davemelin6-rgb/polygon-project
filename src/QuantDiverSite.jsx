        ...
        <div className="qd-wrap">
          ...
          <div style={{ background: "rgba(0,0,0,.3)", border: `1px solid ${T.border}`, borderRadius: 16, overflow: "hidden", marginBottom: 40 }}>
            ...
            <div style={{ padding: "24px 32px", borderBottom: `1px solid ${T.border}`, display: "flex", alignItems: "center", justifyContent: "space-between", flexWrap: "wrap", gap: 12 }}>
              <div>
                <div style={{ fontFamily: ff.mono, fontSize: ".65rem", fontWeight: 700, letterSpacing: ".16em", textTransform: "uppercase", color: T.cyan, marginBottom: 4 }}>
                  Back-test results · 3,136 data points · 65 stocks · 12 months of history
                </div>
            ...
            <div style={{ padding: "20px 32px", display: "flex", alignItems: "center", gap: 24, flexWrap: "wrap" }}>
              <div>
                <div style={{ fontFamily: ff.mono, fontSize: "2rem", fontWeight: 700, color: T.cyan }}>+16.56%</div>
        ...
        <div className="qd-wrap">
          ...
          <div style={{
            ...
            <div style={{ fontFamily: ff.mono, fontSize: ".68rem", fontWeight: 700, letterSpacing: ".16em", textTransform: "uppercase", color: T.cyan, marginBottom: 24 }}>
              📊 Weekly back-testing · Running automatically · 65 tickers · 3,136 data points
            </div>
      ...
      <section style={{ padding: "96px 0", background: "linear-gradient(180deg, transparent, rgba(139,92,246,.04) 50%, transparent)" }}>
        <div className="qd-wrap">
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 0, maxWidth: 780, margin: "0 auto 56px" }}>
            {[
              { num: "01", icon: "🌐", title: "Universe Selection", color: T.cyan, desc: "55+ stocks across AI, Quantum Computing, Defence & Space, Biotech, and Semiconductors. Each ticker is curated — we cover the sectors defining the next 20 years, not the whole market." },
              { num: "02", icon: "📡", title: "Data Ingestion", color: "#22D3EE", desc: "Live price data (Polygon.io) and fundamental data (FMP) flow in continuously. Price history, volume, balance sheets, revenue growth, R&D spend, analyst estimates — all normalised for comparison." },
              { num: "03", icon: "⚙️", title: "Four Independent Models", color: "#a78bfa", desc: "MOMENTUM measures price trend and acceleration. RISK measures balance sheet strength. TECH VALUE measures business quality. INNOVATION measures R&D productivity and adoption trajectory. Each runs independently — no circular logic." },
              { num: "04", icon: "🔢", title: "Signal Synthesis", color: "#f59e0b", desc: "The four scores combine into one Signal Score (0–100) using proprietary weights derived from back-test data: MOM 45% · INNOV 30% · TECH 15% · RISK 10%. Weights evolve as the back-test data grows." },
              { num: "05", icon: "🌍", title: "Macro Overlay", color: "#10B981", desc: "The same stock scores differently depending on the market environment. VIX regime, fear/greed conditions, and sector rotation signals adjust the final output — because a great company in a crisis market still goes down." },
              { num: "06", icon: "📊", title: "Grade Assignment", color: "#00dc82", desc: "A (≥70): Act. B (55–70): Watch. C (40–55): Wait. D (<40): Avoid. One clear decision per stock. No ambiguity, no information overload. The grade tells you what to do with the signal." },
              { num: "07", icon: "✅", title: "Validation Loop", color: "#00dc82", desc: "Every prediction is recorded with a timestamp and price. 90 and 180 days later, we check if we were right. Every Sunday, the engine re-validates against 12 months of history. If the model drifts, we fix it." },
            ].map((s, i) => (
              <div key={s.num} style={{ display: "flex", gap: 0, position: "relative" }}>
                {i < 6 && <div style={{ position: "absolute", left: 27, top: 56, width: 2, height: "calc(100% - 0px)", background: `linear-gradient(180deg, ${s.color}40, transparent)`, zIndex: 0 }} />}
                <div style={{ display: "flex", gap: 20, alignItems: "flex-start", padding: "20px 0", position: "relative", zIndex: 1 }}>
                  <div style={{ flexShrink: 0, width: 56, height: 56, borderRadius: 16, background: s.color + "15", border: `1px solid ${s.color}40`, display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", gap: 2 }}>
          ...
          <div style={{ background: "rgba(139,92,246,.06)", border: "1px solid rgba(139,92,246,.2)", borderRadius: 16, padding: "28px 36px", display: "flex", alignItems: "center", gap: 32, flexWrap: "wrap", maxWidth: 780, margin: "0 auto" }}>
