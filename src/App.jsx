        ...
        <div className="fi-verdict" style={{ borderColor: verdict.color + "35", background: verdict.color + "0e" }}>
          <div className="fi-verdict-left">
            ...
            <div>
              ...
              <div style={{ fontSize: ".65rem", color: "#2a4060", marginTop: 4, fontStyle: "italic" }}>
                90-day signal · not a short-term trade
              </div>
            </div>
          </div>
      ...
      <footer className="app-footer">
        ...
        <div style={{
          ...
          <p style={{ color: "#3d5c78", fontSize: "0.82rem", lineHeight: 1.7, maxWidth: 680, margin: "0 auto" }}>
            ...
            <a href="mailto:administrator@quantdiver.com" style={{ color: "#00b4ff", textDecoration: "none", fontWeight: 600 }}>
              administrator@quantdiver.com
            </a>
          </p>
